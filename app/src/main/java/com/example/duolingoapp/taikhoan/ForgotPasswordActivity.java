        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(ForgotPasswordActivity.this,"Hãy kiểm tra (Hộp thư đến) của bạn để " +
                            "tiến hành thiết lập lại mật khẩu!", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(ForgotPasswordActivity.this,"KHÔNG THÀNH CÔNG!Hãy kiểm tra lại Email của bạn " +
                            "và thử lại!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
